import { neon } from '@neondatabase/serverless';                                                              
  ...
  export async function getAvailableMiles(runnerId, totalMiles = 26.2) {                                        
    ...
    // Generate all possible miles (1 through totalMiles, plus .1 increments for half marathons)                
    ...
    // Add the final mile if it's a decimal (like 26.2 or 13.1)                                                 
    ...
    try {                                                                                                       
      const result = await db`                                                                                  
        INSERT INTO mile_sponsorships                                                                           
          (runner_id, mile_number, sponsor_name, sponsor_email, dedication, amount, transaction_id,             
  is_anonymous)                                                                                                 
        VALUES                                                                                                  
          (${runner_id}, ${mile_number}, ${sponsor_name}, ${sponsor_email}, ${dedication}, ${amount},           
  ${transaction_id}, ${is_anonymous})                                                                           
      ...
      if (error.code === '23505') {                                                                             
        // Unique constraint violation - mile already sponsored                                                 
